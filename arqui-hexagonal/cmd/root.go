...
import (
	...
	dbInfra "github.com/josemoura212/FullCycle/arqui-hexagonal/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.arqui-hexagonal.yaml)")
